  ...
  return (
    <div className='flex flex-col max-w-2xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100'>
      ...
      <div className='p-8 pb-4 text-center'>
        <h2 className='text-3xl font-extrabold text-gray-900 tracking-tight'>Register Digital Art</h2>
        <p className='text-gray-500 mt-2 text-lg'>Upload your masterpiece to the blockchain and claim ownership.</p>
      </div>
      ...
      <div className='p-8 pt-4 flex flex-col items-center gap-6'>
        ...
        <div className="flex flex-col items-center gap-4 w-full">
          ...
          >
            ...
            <img src="/Upload.png" alt="" className="w-5 h-5 invert" />
          </button>
        </div>
      </div>
    </div>
